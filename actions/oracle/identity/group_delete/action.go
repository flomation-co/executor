// Package oracle_identity_group_delete permanently deletes an IAM group by OCID.
package oracle_identity_group_delete
...
const (
	...
	Name         = "OCI Identity: Delete Group"
	Description  = "Permanently delete an Oracle Cloud IAM group by OCID. Remove its members first if OCI reports it is not empty. Synchronous."
...
var Inputs = [...]core.Connection{
	...
	{Name: "group_ocid", Type: core.ConnectionTypeString, Label: "Group OCID (to delete)", Placeholder: "ocid1.group.oc1..aaaa… of the group to delete", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if _, err := client.DeleteGroup(iam.Context(), identity.DeleteGroupRequest{GroupId: &id}); err != nil {
		return iam.ErrorResult(auth.OCIError(err)), nil
	}
	return iam.Result(fmt.Sprintf("Deleted group %s", id), map[string]interface{}{"id": id}), nil
}
