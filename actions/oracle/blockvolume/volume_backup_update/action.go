// Package oracle_blockvolume_volume_backup_update renames a block-volume backup
// and/or replaces its freeform tags.
package oracle_blockvolume_volume_backup_update
...
const (
	...
	Name         = "OCI Block Volumes: Update Volume Backup"
	Description  = "Update an Oracle Cloud block-volume backup — change its display name and/or freeform tags."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	details := ocicore.UpdateVolumeBackupDetails{}
	...
	resp, err := client.UpdateVolumeBackup(bv.Context(), ocicore.UpdateVolumeBackupRequest{
		VolumeBackupId:            &id,
		UpdateVolumeBackupDetails: details,
	})
	if err != nil {
	...
	return map[string]interface{}{
		"tool_result":     fmt.Sprintf("Updated volume backup %q (%s)", backup["display_name"], backup["lifecycle_state"]),
		"backup":          backup,
		"id":              backup["id"],
