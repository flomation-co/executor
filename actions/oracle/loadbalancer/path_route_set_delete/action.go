// Package oracle_loadbalancer_path_route_set_delete deletes a path route set from a
// load balancer by name. Deletion is asynchronous — returns a work-request id.
package oracle_loadbalancer_path_route_set_delete
...
const (
	...
	Name         = "OCI Load Balancer: Delete Path Route Set"
	Description  = "Delete a path route set from an Oracle Cloud load balancer by name. Deletion is asynchronous — returns a work-request id to poll with Get Work Request."
...
var Inputs = [...]core.Connection{
	...
	{Name: "path_route_set_name", Type: core.ConnectionTypeString, Label: "Path Route Set Name", Placeholder: "e.g. example_path_route_set", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.DeletePathRouteSet(lbn.Context(), lb.DeletePathRouteSetRequest{
		LoadBalancerId:   &lbID,
	...
	return map[string]interface{}{
		"tool_result":         fmt.Sprintf("Delete requested for path route set %q on load balancer %s — poll work request %s", name, lbID, lbn.Str(resp.OpcWorkRequestId)),
