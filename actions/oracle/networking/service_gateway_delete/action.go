// Package oracle_networking_service_gateway_delete deletes a service gateway by OCID.
package oracle_networking_service_gateway_delete
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err := client.DeleteServiceGateway(net.Context(), ocicore.DeleteServiceGatewayRequest{ServiceGatewayId: &id})
	if err != nil {
