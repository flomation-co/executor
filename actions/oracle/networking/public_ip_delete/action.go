// Package oracle_networking_public_ip_delete deletes a reserved public IP by OCID.
package oracle_networking_public_ip_delete
...
const (
	...
	Name         = "OCI Networking: Delete Public IP"
	Description  = "Delete an Oracle Cloud public IP by OCID."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err := client.DeletePublicIp(net.Context(), ocicore.DeletePublicIpRequest{PublicIpId: &id})
	if err != nil {
