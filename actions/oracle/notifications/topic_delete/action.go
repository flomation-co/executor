// Package oracle_notifications_topic_delete deletes a Notifications topic by OCID.
package oracle_notifications_topic_delete
...
const (
	...
	Description  = "Delete an Oracle Cloud Notifications topic by its OCID. This also removes its subscriptions and cannot be undone."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if _, err := client.DeleteTopic(ons.Context(), onssdk.DeleteTopicRequest{TopicId: &id}); err != nil {
		return ons.ErrorResult(auth.OCIError(err)), nil
	}
	return ons.Result("Deleted topic "+id, map[string]interface{}{
		"topic_id": id,
	}), nil
}
