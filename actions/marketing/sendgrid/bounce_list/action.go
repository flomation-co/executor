package marketing_sendgrid_bounce_list
...
var Inputs = [...]core.Connection{
	...
	{Name: "start_time", Type: core.ConnectionTypeDateTime, Label: "Start Time", Placeholder: "Only bounces created on or after this time, e.g. 2026-07-01T00:00:00Z"},
	{Name: "end_time", Type: core.ConnectionTypeDateTime, Label: "End Time", Placeholder: "Only bounces created on or before this time, e.g. 2026-07-08T23:59:59Z"},
...
var Outputs = [...]core.Connection{
	{Name: "results", Type: core.ConnectionTypeObject, Label: "Bounces"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, err := sendgrid.ListOffset(auth, "/v3/suppression/bounces", query, limit, returnAll)
	if err != nil {
		return sendgrid.ErrorResult(err.Error()), nil
	}
	return sendgrid.ListResult(items, len(items), fmt.Sprintf("Retrieved %d bounce(s)", len(items))), nil
}
