package marketing_sendgrid_spam_report_list
...
var Inputs = [...]core.Connection{
	...
	{Name: "start_time", Type: core.ConnectionTypeDateTime, Label: "Start Time", Placeholder: "Only spam reports created on or after this time, e.g. 2026-07-01T00:00:00Z"},
	{Name: "end_time", Type: core.ConnectionTypeDateTime, Label: "End Time", Placeholder: "Only spam reports created on or before this time, e.g. 2026-07-08T23:59:59Z"},
...
var Outputs = [...]core.Connection{
	{Name: "results", Type: core.ConnectionTypeObject, Label: "Spam Reports"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, err := sendgrid.ListOffset(auth, "/v3/suppression/spam_reports", query, limit, returnAll)
	if err != nil {
		return sendgrid.ErrorResult(err.Error()), nil
	}
	return sendgrid.ListResult(items, len(items), fmt.Sprintf("Retrieved %d spam report(s)", len(items))), nil
}
