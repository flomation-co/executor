package marketing_sendgrid_invalid_email_list
...
var Inputs = [...]core.Connection{
	...
	{Name: "start_time", Type: core.ConnectionTypeDateTime, Label: "Start Time", Placeholder: "Only invalid email entries created on or after this time, e.g. 2026-07-01T00:00:00Z"},
	{Name: "end_time", Type: core.ConnectionTypeDateTime, Label: "End Time", Placeholder: "Only invalid email entries created on or before this time, e.g. 2026-07-08T23:59:59Z"},
...
var Outputs = [...]core.Connection{
	{Name: "results", Type: core.ConnectionTypeObject, Label: "Invalid Emails"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, err := sendgrid.ListOffset(auth, "/v3/suppression/invalid_emails", query, limit, returnAll)
	if err != nil {
		return sendgrid.ErrorResult(err.Error()), nil
	}
	return sendgrid.ListResult(items, len(items), fmt.Sprintf("Retrieved %d invalid email(s)", len(items))), nil
}
