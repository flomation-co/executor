package messagebrokers_azureservicebus_queue_receive
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err != nil {
		return sb.Fail(auth, fmt.Sprintf("Could not receive from queue %s", spec.Entity()), err), nil
	}
	...
	return sb.MessagesResult(sb.MessagesOutput(msgs, sb.OptionalBool("parse_json", inputs)), "Received", "queue "+spec.Entity()), nil
}
