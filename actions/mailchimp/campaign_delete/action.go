package mailchimp_campaign_delete
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err := mailchimp.RequestNoContent(apiKey, http.MethodDelete, mailchimp.CampaignPath(id), nil); err != nil {
		return mailchimp.ErrorResult(err.Error()), nil
	}
	return mailchimp.SuccessResult("Deleted campaign " + id), nil
}
