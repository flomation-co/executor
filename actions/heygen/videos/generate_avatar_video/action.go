...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	// HeyGen wants `engine`/`background` as objects; agents and the raw_json path
	// often pass plain strings, which HeyGen rejects with "Input should be a
	// valid dictionary or object". Coerce so either form works, from any source.
