package ecommerce_woocommerce_product_create
...
var Inputs = [...]core.Connection{
	...
	{Name: "name", Type: core.ConnectionTypeString, Label: "Name", Placeholder: "Product name", Required: true},
	{
		Name:  "type",
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if _, err := woocommerce.RequiredString("name", inputs); err != nil {
	...
	resp, err := woocommerce.CreateResource(auth, "/products", product)
	if err != nil {
		return woocommerce.ErrorResult(err.Error()), nil
	}
