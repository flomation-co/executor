package ecommerce_woocommerce_coupon_create
...
var Inputs = [...]core.Connection{
	...
	{Name: "code", Type: core.ConnectionTypeString, Label: "Coupon Code", Placeholder: "SAVE10", Required: true},
	{
		Name:  "discount_type",
	...
	{Name: "additional_fields", Type: core.ConnectionTypeObject, Label: "Additional Fields (JSON)", Placeholder: `{"date_expires_gmt":"2026-12-31T23:59:59"}`},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if _, err := woocommerce.RequiredString("code", inputs); err != nil {
	...
	resp, err := woocommerce.CreateResource(auth, "/coupons", coupon)
	if err != nil {
		return woocommerce.ErrorResult(err.Error()), nil
	}
	out := woocommerce.ResourceResult(resp, "")
	out["tool_result"] = fmt.Sprintf("Created coupon %s", out["id"])
	return out, nil
}
