...
var Inputs = [...]core.Connection{
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "%Trade% with Contains - the % signs are the wildcard; or Retail,Trade for Is One Of"},
