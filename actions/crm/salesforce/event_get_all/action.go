...
var Inputs = [...]core.Connection{
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "Head office — or a date shortcut like THIS_WEEK"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if after != "" {
		conditions = append(conditions, salesforce.Condition{Field: "StartDateTime", Operator: ">=", Value: after})
	}
	...
	if before != "" {
		conditions = append(conditions, salesforce.Condition{Field: "StartDateTime", Operator: "<=", Value: before})
	}
	...
	default:
		out["tool_result"] = fmt.Sprintf("Found %d event(s)", len(records))
	}
	return out, nil
}
