...
const (
	...
	Name         = "Salesforce: Get Many Orders"
	Description  = "List orders from Salesforce, optionally filtered - everything still in draft, every order on one account, everything activated this week. Turn on Return All to fetch every match."
...
//
// The order number, the customer, the status and the money lead, because that is
// what anyone working an order list needs. StatusCode is included alongside Status
// on purpose: Status is what an admin can rename, StatusCode is the fixed value
// Salesforce reasons about (Draft, Activated, Canceled, Expired, Superseded), so a
// flow that branches on it keeps working after someone relabels a picklist.
const defaultFields = "Id,OrderNumber,Name,AccountId,ContractId,Status,StatusCode,Type,EffectiveDate,EndDate,TotalAmount,Pricebook2Id,PoNumber,BillToContactId,ShipToContactId,ActivatedDate,OwnerId,LastModifiedDate"

var Inputs = [...]core.Connection{
	{Name: "access_token", Type: core.ConnectionTypeSecret, Label: "Salesforce Connection", Placeholder: "Connect Salesforce, or paste an access token", Required: true},
	{Name: "instance_url", Type: core.ConnectionTypeString, Label: "Salesforce Instance URL", Placeholder: "https://mycompany.my.salesforce.com", Required: true},
	{Name: "fields", Type: core.ConnectionTypeString, Label: "Fields", Placeholder: "OrderNumber,Status,TotalAmount,EffectiveDate - leave blank for the usual order fields"},
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "Draft - or Activated, or a date word like THIS_MONTH, or Draft,Activated for Is One Of"},
	{Name: "filter_conditions", Type: core.ConnectionTypeObject, Label: "More Filters", Placeholder: "[{\"field\":\"TotalAmount\",\"operator\":\">\",\"value\":\"10000\"},{\"field\":\"EffectiveDate\",\"operator\":\">=\",\"value\":\"THIS_MONTH\"}] - extra filters"},
	{Name: "match_any_filter", Type: core.ConnectionTypeBoolean, Label: "Match ANY filter instead of all"},
	{Name: "order_by", Type: core.ConnectionTypeString, Label: "Sort By", Placeholder: "EffectiveDate DESC - or TotalAmount DESC"},
	...
	{Name: "include_deleted", Type: core.ConnectionTypeBoolean, Label: "Include Deleted Orders (Recycle Bin)"},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	// field's real Salesforce type via one cached describe. On an order that is
	// what makes "TotalAmount > 10000" render bare (currency) and "EffectiveDate >=
	// THIS_MONTH" render as a bare date keyword, while "Status = 'Draft'" stays
	// quoted. Under a value-only heuristic the first two are hard INVALID_FIELD
	// errors, and "orders over £10,000 this month" is the whole point of the list.
...
// the execution view is a sentence rather than "1 orders".
