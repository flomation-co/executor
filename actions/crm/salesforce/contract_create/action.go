...
var Inputs = [...]core.Connection{
	...
	{Name: "contract_status", Type: core.ConnectionTypeString, Label: "Status", Placeholder: "Draft or In Approval Process - leave blank and Salesforce starts it as Draft. A contract cannot be created as Activated; add an Activate Contract step for that"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err != nil {
		return salesforce.ErrorResult(explainCreateFailure(err)), nil
	}
...
func explainCreateFailure(err error) string {
	switch {
