// Package deal_delete implements the Freshsales "Deal: Delete" action.
package deal_delete
...
const (
	...
	Name         = "Deal: Delete"
	Description  = "Delete a Freshsales deal by ID."
	Summary      = "Delete a deal in Freshsales"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.Do(flow, http.MethodDelete, "/deals/"+idValue, nil, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.OkResult("Deleted deal"), nil
}
