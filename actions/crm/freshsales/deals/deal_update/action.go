// Package deal_update implements the Freshsales "Deal: Update" action.
package deal_update
...
const (
	...
	Name         = "Deal: Update"
	Description  = "Update an existing Freshsales deal. Only the fields you set are changed."
	Summary      = "Change a deal in Freshsales"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.Do(flow, http.MethodPut, "/deals/"+idValue, payload, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}
	...
	return freshsales_common.ObjectResult(recordOut, fmt.Sprintf("Updated deal %s", freshsales_common.NameOf(recordOut))), nil
}
