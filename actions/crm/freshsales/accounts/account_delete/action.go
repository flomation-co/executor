// Package account_delete implements the Freshsales "Account: Delete" action.
package account_delete
...
const (
	...
	Name         = "Account: Delete"
	Description  = "Delete a Freshsales account by ID."
	Summary      = "Delete an account in Freshsales"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.Do(flow, http.MethodDelete, "/sales_accounts/"+idValue, nil, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.OkResult("Deleted account"), nil
}
