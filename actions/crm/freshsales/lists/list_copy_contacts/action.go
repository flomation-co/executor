// Package list_copy_contacts implements the Freshsales "List: Copy Contacts" action.
package list_copy_contacts
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.Do(flow, http.MethodPost, "/lists/"+idValue+"/copy_contacts", payload, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.PlainResult(resp, "Copied contacts"), nil
}
