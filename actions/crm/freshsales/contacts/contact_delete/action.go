// Package contact_delete implements the Freshsales "Contact: Delete" action.
package contact_delete
...
const (
	...
	Summary      = "Delete a contact in Freshsales"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.Do(flow, http.MethodDelete, "/contacts/"+idValue, nil, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.OkResult("Deleted contact"), nil
}
