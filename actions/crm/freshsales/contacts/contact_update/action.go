// Package contact_update implements the Freshsales "Contact: Update" action.
...
const (
	...
	Name         = "Contact: Update"
	Description  = "Update an existing Freshsales contact. Only the fields you set are changed."
	Summary      = "Change a contact in Freshsales"
...
var Inputs = [...]core.Connection{
	...
	{Name: "id", Type: core.ConnectionTypeString, Label: "Contact ID", Placeholder: "12345", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.Do(flow, http.MethodPut, "/contacts/"+idValue, payload, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}
	...
	return freshsales_common.ObjectResult(recordOut, fmt.Sprintf("Updated contact %s", freshsales_common.NameOf(recordOut))), nil
}
