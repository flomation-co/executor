// Package contact_bulk_delete implements the Freshsales "Bulk: Delete Contacts" action.
package contact_bulk_delete
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.Do(flow, http.MethodPost, "/contacts/bulk_destroy", payload, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.PlainResult(resp, "Bulk delete contacts"), nil
}
