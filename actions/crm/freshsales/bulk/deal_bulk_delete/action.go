// Package deal_bulk_delete implements the Freshsales "Bulk: Delete Deals" action.
package deal_bulk_delete
...
const (
	...
	Description  = "Delete many deals in one call by ID."
	Summary      = "Delete many deals at once"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := client.Do(flow, http.MethodPost, "/deals/bulk_destroy", payload, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.PlainResult(resp, "Bulk delete deals"), nil
}
