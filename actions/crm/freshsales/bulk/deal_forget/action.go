// Package deal_forget implements the Freshsales "GDPR: Forget Deal" action.
package deal_forget
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.Do(flow, http.MethodDelete, "/deals/"+idValue+"/forget", nil, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.OkResult("Erased deal"), nil
}
