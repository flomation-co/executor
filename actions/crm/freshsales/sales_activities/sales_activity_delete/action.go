// Package sales_activity_delete implements the Freshsales "Sales Activity: Delete" action.
package sales_activity_delete
...
const (
	...
	Name         = "Sales Activity: Delete"
	Description  = "Delete a Freshsales sales activity by ID."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.Do(flow, http.MethodDelete, "/sales_activities/"+idValue, nil, query)
	if err != nil {
		return freshsales_common.ErrorResult(err.Error()), nil
	}

	return freshsales_common.OkResult("Deleted sales activity"), nil
}
