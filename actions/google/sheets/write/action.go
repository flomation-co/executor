// Package write writes data to a range of cells in a Google Sheet.
package write
...
var Inputs = [...]core.Connection{
	...
	{Name: "range", Type: core.ConnectionTypeString, Label: "Range", Required: true, Placeholder: "Sheet1!A1"},
	{Name: "data", Type: core.ConnectionTypeText, Label: "Data (JSON 2D array)", Required: true, Placeholder: `[["Name","Age"],["Alice",30]]`},
	{
		Name:  "value_input",
...
var Outputs = [...]core.Connection{
	...
	{Name: "updated_cells", Type: core.ConnectionTypeInteger, Label: "Updated Cells"},
	{Name: "updated_rows", Type: core.ConnectionTypeInteger, Label: "Updated Rows"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	endpoint := fmt.Sprintf("%s/%s/values/%s?valueInputOption=%s",
		sheetsAPI, spreadsheetID, cellRange, valueInput)

	status, respBody, err := google.DoRequest(flow, "PUT", endpoint, token.AccessToken, body)
	if err != nil {
		return google.ErrorResult(err.Error())
	}
	...
	return map[string]interface{}{
		"tool_result":   fmt.Sprintf("Wrote %d cells (%d rows) to %s", resp.UpdatedCells, resp.UpdatedRows, resp.UpdatedRange),
