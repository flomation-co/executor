// Package azure_cosmosdb_container_delete deletes a container and every item
// in it. Cosmos returns 204 with no body; the result echoes what was deleted.
package azure_cosmosdb_container_delete
...
const (
	...
	Name         = "Cosmos DB: Delete Container"
	Description  = "Delete a container from a database, including every item inside it. This cannot be undone."
...
var Inputs = [...]core.Connection{
	...
	{Name: "container", Type: core.ConnectionTypeString, Label: "Container", Placeholder: "The ID of the container to delete", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := cosmosdb.DoRequest(flow, auth, http.MethodDelete, cosmosdb.CollPath(db, coll), "colls", cosmosdb.CollRID(db, coll), nil, nil)
	if err != nil {
		return cosmosdb.ErrorResult(err.Error()), nil
	}
