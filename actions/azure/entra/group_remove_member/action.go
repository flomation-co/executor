package azure_entra_group_remove_member
...
const (
	...
	Name         = "Entra ID: Remove Group Member"
	Description  = "Remove one member from a group. The member itself is untouched. Requires the GroupMember.ReadWrite.All application permission."
...
var Inputs = [...]core.Connection{
	...
	{Name: "user_id", Type: core.ConnectionTypeString, Label: "Member (User ID)", Placeholder: "User object ID (GUID) to remove", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return entra.EchoResult(userID, echo, fmt.Sprintf("Removed member %s from group %s", userID, groupID)), nil
}
