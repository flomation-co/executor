package devops_jenkins_instance_safe_restart
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := jenkins.Post(cfg, "/safeRestart", "", nil)
	if err != nil {
	...
	return jenkins.SuccessResult("Jenkins will restart once running builds finish", nil), nil
}
