package scheduling_calcom_team_get_all
...
const (
	...
	Name         = "Cal.com: Get Many Teams"
	Description  = "List the Cal.com teams you belong to."
	Website      = "https://www.flomation.co"
	Icon         = "calcom+user-group"
	Date         = "03/07/2026"
...
var Inputs = [...]core.Connection{
	...
	{Name: "return_all", Type: core.ConnectionTypeBoolean, Label: "Return All", Placeholder: "Follow pagination and return every team"},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, next, _, err := calcom.ListResources(token, "/teams", calcom.VersionNone, nil, calcom.ClampLimit(limit, set), skip, returnAll)
	if err != nil {
		return calcom.ErrorResult(err.Error()), nil
	}
	return calcom.ListResult(items, next, fmt.Sprintf("Retrieved %d teams", len(items))), nil
}
