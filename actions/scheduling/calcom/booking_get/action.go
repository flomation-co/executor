package scheduling_calcom_booking_get
...
const (
	...
	Description  = "Retrieve a single Cal.com booking by its UID."
...
var Inputs = [...]core.Connection{
	...
	{Name: "booking_uid", Type: core.ConnectionTypeString, Label: "Booking UID", Placeholder: "e.g. 8s7dHT8knaXm...", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := calcom.GetResource(token, "/bookings/"+url.PathEscape(uid), calcom.VersionBookings, nil)
	if err != nil {
		return calcom.ErrorResult(err.Error()), nil
	}
	return calcom.ResourceResult(resp, fmt.Sprintf("Retrieved booking %s", uid)), nil
}
