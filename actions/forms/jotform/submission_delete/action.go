// Package submission_delete deletes a JotForm submission by ID.
package submission_delete
...
const (
	...
	Summary      = "Delete a JotForm submission for good"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	raw, status, err := jotform.Do(jotform.Context(flow), http.MethodDelete, "/submission/"+submissionID, apiKey, region, nil)
	if err != nil {
	...
	return map[string]interface{}{
		"tool_result":   fmt.Sprintf("Deleted JotForm submission %s.", submissionID),
