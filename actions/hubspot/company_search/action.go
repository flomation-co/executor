package hubspot_company_search
...
const (
	...
	Name         = "Company: Search"
	Description  = "Search HubSpot companies by free text or a property filter (e.g. domain EQ acme.com). Returns matching companies."
	Summary      = "Search for companies in HubSpot"
...
var Inputs = [...]core.Connection{
	...
	{Name: "filter_property", Type: core.ConnectionTypeString, Label: "Filter Property", Placeholder: "domain"},
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "acme.com"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := hubspot.SearchObjects(apiKey, "companies", body)
	if err != nil {
		return hubspot.ErrorResult(err.Error()), nil
	}

	out := hubspot.ListResult(resp, "")
	out["tool_result"] = fmt.Sprintf("Found %v companies", out["count"])
	return out, nil
}
