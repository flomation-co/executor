package hubspot_tickets_search
...
var Inputs = [...]core.Connection{
	...
	{Name: "filter_property", Type: core.ConnectionTypeString, Label: "Filter Property", Placeholder: "hs_ticket_priority"},
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "HIGH"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := hubspot.SearchObjects(apiKey, "tickets", body)
	if err != nil {
		return hubspot.ErrorResult(err.Error()), nil
	}

	out := hubspot.ListResult(resp, "")
	out["tool_result"] = fmt.Sprintf("Found %v tickets", out["count"])
	return out, nil
}
