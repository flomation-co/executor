...
var Inputs = [...]core.Connection{
	...
	{Name: "filter_property", Type: core.ConnectionTypeString, Label: "Filter Property", Placeholder: "dealstage"},
	...
	{Name: "filter_value", Type: core.ConnectionTypeString, Label: "Filter Value", Placeholder: "closedwon"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := hubspot.SearchObjects(apiKey, "deals", body)
	if err != nil {
		return hubspot.ErrorResult(err.Error()), nil
	}

	out := hubspot.ListResult(resp, "")
	out["tool_result"] = fmt.Sprintf("Found %v deals", out["count"])
	return out, nil
}
