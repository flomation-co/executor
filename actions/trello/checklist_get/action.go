...
const (
	...
	Name         = "Get Checklist"
	Description  = "Fetch a single Trello checklist by its ID."
	Summary      = "Look up a checklist in Trello"
...
var Inputs = [...]core.Connection{
	...
	{Name: "id", Type: core.ConnectionTypeString, Label: "Checklist ID", Placeholder: "The ID of the checklist to fetch", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	obj, err := trello.GetObject(auth, "/checklists/"+url.PathEscape(id), params)
	if err != nil {
		return trello.ErrorResult(err.Error()), nil
	}
	return trello.ResourceResult(obj, "Retrieved checklist "+id), nil
}
