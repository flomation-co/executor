...
var Inputs = [...]core.Connection{
	...
	{Name: "id", Type: core.ConnectionTypeString, Label: "List", Placeholder: "The list whose cards to fetch", Required: true},
	{Name: "fields", Type: core.ConnectionTypeString, Label: "Fields", Placeholder: "Comma-separated fields to return (default: all)"},
}

var Outputs = [...]core.Connection{
	{Name: "results", Type: core.ConnectionTypeObject, Label: "Cards"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, err := trello.GetArray(auth, "/lists/"+url.PathEscape(id)+"/cards", params)
	if err != nil {
		return trello.ErrorResult(err.Error()), nil
	}
	return trello.ListResult(items, fmt.Sprintf("Retrieved %d card(s)", len(items))), nil
}
