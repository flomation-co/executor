...
var Inputs = [...]core.Connection{
	...
	{Name: "id", Type: core.ConnectionTypeString, Label: "Attachment ID", Placeholder: "The ID of the attachment to fetch", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	obj, err := trello.GetObject(auth, "/cards/"+url.PathEscape(cardID)+"/attachments/"+url.PathEscape(id), params)
	if err != nil {
		return trello.ErrorResult(err.Error()), nil
	}
	return trello.ResourceResult(obj, "Retrieved attachment "+id), nil
}
