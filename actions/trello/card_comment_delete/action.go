package trello_card_comment_delete
...
const (
	...
	Summary      = "Delete a comment in Trello"
...
var Inputs = [...]core.Connection{
	...
	{Name: "comment_id", Type: core.ConnectionTypeString, Label: "Comment ID", Placeholder: "The ID of the comment to delete", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err := trello.DeleteOK(auth, "/cards/"+url.PathEscape(cardID)+"/actions/"+url.PathEscape(commentID)+"/comments", url.Values{}); err != nil {
		return trello.ErrorResult(err.Error()), nil
	}
	return trello.SuccessResult(commentID, nil, "Deleted comment "+commentID), nil
}
