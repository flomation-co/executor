...
const (
	...
	Name         = "Get List"
	Description  = "Fetch a single Trello list by its ID. Optionally narrow the returned data with a comma-separated Fields list."
	Summary      = "Look up a list in Trello"
...
var Inputs = [...]core.Connection{
	...
	{Name: "id", Type: core.ConnectionTypeString, Label: "List", Placeholder: "The list to fetch", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	obj, err := trello.GetObject(auth, "/lists/"+url.PathEscape(id), params)
	if err != nil {
		return trello.ErrorResult(err.Error()), nil
	}
	return trello.ResourceResult(obj, "Retrieved list "+id), nil
}
