...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err := jira.DeleteResource(auth, "/issue/"+key+"/comment/"+commentID, nil); err != nil {
		return jira.ErrorResult(err.Error()), nil
	}
	return jira.SuccessResult(commentID, map[string]interface{}{}, "Deleted comment "+commentID), nil
}
