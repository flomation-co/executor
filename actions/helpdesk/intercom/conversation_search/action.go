package helpdesk_intercom_conversation_search
...
var Inputs = [...]core.Connection{
	...
	{Name: "field", Type: core.ConnectionTypeString, Label: "Field", Placeholder: "The field to filter on, e.g. state, source.body, admin_assignee_id, created_at"},
	{
		Name:  "operator",
		Type:  core.ConnectionTypeString,
		Label: "Operator",
...
var Outputs = [...]core.Connection{
	{Name: "results", Type: core.ConnectionTypeObject, Label: "Conversations"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items, err := intercom.SearchAll(auth, "/conversations/search", query, "conversations", limit, returnAll)
	if err != nil {
		return intercom.ErrorResult(err.Error()), nil
	}
	return intercom.ListResult(items, fmt.Sprintf("Found %d conversation(s)", len(items))), nil
}
