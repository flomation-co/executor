package helpdesk_intercom_ticket_delete
...
var Inputs = [...]core.Connection{
	...
	{Name: "ticket_id", Type: core.ConnectionTypeString, Label: "Ticket ID", Placeholder: "The ticket to delete — from a Create Ticket step or a search", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if err := intercom.DeleteResource(auth, "/tickets/"+url.PathEscape(ticketID)); err != nil {
		return intercom.ErrorResult(err.Error()), nil
	}
	return intercom.SuccessResult(ticketID, nil, fmt.Sprintf("Deleted ticket %s", ticketID)), nil
}
