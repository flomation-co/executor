...
var Inputs = [...]core.Connection{
	...
	{Name: "distance_metric", Type: core.ConnectionTypeString, Label: "Distance Metric", Placeholder: "Must match the metric your searches use, or they can't use the index", Options: []core.ConnectionOption{{Name: "Cosine — best for text embeddings", Value: "cosine"}, {Name: "Inner Product", Value: "inner_product"}, {Name: "Euclidean (L2)", Value: "euclidean"}}},
