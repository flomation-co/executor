...
var Inputs = [...]core.Connection{
	...
	{Name: "line_items", Type: core.ConnectionTypeText, Label: "Line Items (JSON array)", Placeholder: `[{"Amount":100.00,"DetailType":"AccountBasedExpenseLineDetail","AccountBasedExpenseLineDetail":{"AccountRef":{"value":"7"}}}]`, Required: true},
	...
	{Name: "doc_number", Type: core.ConnectionTypeString, Label: "Reference / Doc Number"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := quickbooks_common.Post(flow, auth, "bill", body)
	if err != nil {
	...
	return quickbooks_common.ObjectResult(id, obj, fmt.Sprintf("Created QuickBooks bill %s", id)), nil
}
