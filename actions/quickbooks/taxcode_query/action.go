...
var Inputs = [...]core.Connection{
	...
	{Name: "query", Type: core.ConnectionTypeText, Label: "Full SQL Query (overrides WHERE)", Placeholder: "select * from TaxCode"},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	rows := quickbooks_common.QueryRows(resp, "TaxCode")
	return quickbooks_common.ListResult(rows, fmt.Sprintf("Found %d tax codes", len(rows))), nil
}
