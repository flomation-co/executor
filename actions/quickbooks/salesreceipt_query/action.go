...
const (
	...
	Name         = "Sales Receipt: Query"
	Description  = "Query QuickBooks Online sales receipts with SQL-like syntax. Returns matching sales receipt rows."
	Summary      = "Search sales receipts"
...
var Inputs = [...]core.Connection{
	...
	{Name: "query", Type: core.ConnectionTypeString, Label: "Query (SQL)", Placeholder: "select * from SalesReceipt where CustomerRef = '42'"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	rows := quickbooks_common.QueryRows(resp, "SalesReceipt")
	return quickbooks_common.ListResult(rows, fmt.Sprintf("Found %d QuickBooks sales receipt(s)", len(rows))), nil
}
