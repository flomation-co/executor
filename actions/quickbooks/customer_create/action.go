...
var Inputs = [...]core.Connection{
	...
	{Name: "display_name", Type: core.ConnectionTypeString, Label: "Display Name", Placeholder: "Ada Lovelace Ltd", Required: true},
	{Name: "company_name", Type: core.ConnectionTypeString, Label: "Company Name"},
	{Name: "given_name", Type: core.ConnectionTypeString, Label: "First Name", Placeholder: "Ada"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return quickbooks_common.ObjectResult(id, obj, fmt.Sprintf("Created QuickBooks customer %q", quickbooks_common.OptionalString("display_name", inputs))), nil
}
