...
const (
	...
	Name         = "Employee: Query"
	Description  = "Query QuickBooks Online employees. Supply a WHERE clause or a full SQL query."
...
var Inputs = [...]core.Connection{
	...
	{Name: "where", Type: core.ConnectionTypeString, Label: "WHERE Clause", Placeholder: "Active = true"},
	{Name: "max_results", Type: core.ConnectionTypeString, Label: "Max Results", Placeholder: "100"},
	{Name: "query", Type: core.ConnectionTypeText, Label: "Full SQL Query (overrides WHERE)", Placeholder: "select * from Employee"},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	sql := buildQuery("Employee", inputs)
	...
	rows := quickbooks_common.QueryRows(resp, "Employee")
	return quickbooks_common.ListResult(rows, fmt.Sprintf("Found %d employees", len(rows))), nil
}
