...
var Inputs = [...]core.Connection{
	...
	{Name: "doc_number", Type: core.ConnectionTypeString, Label: "Document Number", Placeholder: "CM-1001"},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	resp, err := quickbooks_common.Post(flow, auth, "creditmemo", body)
	if err != nil {
	...
	return quickbooks_common.ObjectResult(id, obj, "Created QuickBooks credit memo "+id), nil
}
