// Package aws_elbv2_describe_load_balancer_attributes reads the attributes of an
// Elastic Load Balancing v2 load balancer.
package aws_elbv2_describe_load_balancer_attributes
...
const (
	...
	Name         = "AWS Describe Load Balancer Attributes"
	Description  = "Read the attributes (key/value settings) of a load balancer."
	Website      = "https://www.flomation.co"
	Icon         = "arrows-split-up-and-left+list"
	Date         = "21/07/2026"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	out, err := client.DescribeLoadBalancerAttributes(ctx, &elbv2.DescribeLoadBalancerAttributesInput{
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Read %d attribute(s) for %s", len(attributes), arn),
