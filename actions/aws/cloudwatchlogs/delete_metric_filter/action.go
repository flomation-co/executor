// Package aws_cloudwatchlogs_delete_metric_filter deletes a CloudWatch Logs metric filter.
package aws_cloudwatchlogs_delete_metric_filter
...
const (
	...
	Name         = "AWS CloudWatch Logs Delete Metric Filter"
	Description  = "Delete a metric filter from a CloudWatch Logs log group."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.DeleteMetricFilter(ctx, &cwlogs.DeleteMetricFilterInput{
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted metric filter %s from %s", filterName, logGroup),
