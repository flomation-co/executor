// Package aws_s3_put_access_point_policy attaches a policy document to an AWS S3 access point.
package aws_s3_put_access_point_policy
...
const (
	...
	Name         = "AWS S3 Put Access Point Policy"
	Description  = "Attach a JSON policy document to an AWS S3 access point."
	Website      = "https://www.flomation.co"
	Icon         = "circle-nodes+lock"
	Date         = "21/07/2026"
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Applied policy to access point %s", name),
		"name":        name,
	}, nil
}
