// Package aws_s3_put_bucket_acl applies a canned ACL to a bucket.
package aws_s3_put_bucket_acl
...
const (
	...
	Description  = "Apply a canned access control list to an AWS S3 bucket."
...
var Inputs = [...]core.Connection{
	...
	{Name: "acl", Type: core.ConnectionTypeString, Label: "Canned ACL", Required: true, Options: []core.ConnectionOption{
		...
		{Name: "Log Delivery Write", Value: "log-delivery-write"},
	}},
}
...
var Outputs = [...]core.Connection{
	...
	{Name: "acl", Type: core.ConnectionTypeString, Label: "Canned ACL"},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if acl == "" {
		return nil, fmt.Errorf("canned ACL is required")
	}
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Applied ACL %q to bucket %s", acl, bucket),
		"bucket":      bucket,
		"acl":         acl,
	}, nil
}
