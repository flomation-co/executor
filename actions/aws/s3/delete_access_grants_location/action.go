// Package aws_s3_delete_access_grants_location deregisters an S3 Access Grants location.
package aws_s3_delete_access_grants_location
...
const (
	...
	Name         = "AWS S3 Delete Access Grants Location"
	Description  = "Deregister a location from S3 Access Grants."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.DeleteAccessGrantsLocation(ctx, &s3control.DeleteAccessGrantsLocationInput{
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted S3 Access Grants location %s", locationID),
	}, nil
}
