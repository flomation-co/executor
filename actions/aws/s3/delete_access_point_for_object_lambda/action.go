// Package aws_s3_delete_access_point_for_object_lambda deletes an S3 Object Lambda Access Point.
package aws_s3_delete_access_point_for_object_lambda
...
const (
	...
	Name         = "AWS S3 Delete Object Lambda Access Point"
	Description  = "Delete an S3 Object Lambda Access Point by name."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted Object Lambda Access Point %s", name),
	}, nil
}
