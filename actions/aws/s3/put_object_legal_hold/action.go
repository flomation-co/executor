// Package aws_s3_put_object_legal_hold sets an object's legal hold status.
package aws_s3_put_object_legal_hold
...
const (
	...
	Name         = "AWS S3 Put Object Legal Hold"
	Description  = "Place or remove a legal hold on an AWS S3 object version."
...
var Inputs = [...]core.Connection{
	...
	{Name: "status", Type: core.ConnectionTypeString, Label: "Legal Hold Status", Required: true, Options: []core.ConnectionOption{
		{Name: "On", Value: "ON"},
		{Name: "Off", Value: "OFF"},
	}},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if status == "" {
		return nil, fmt.Errorf("legal hold status is required")
	}
	...
	in := &awsS3.PutObjectLegalHoldInput{
	...
	_, err = client.PutObjectLegalHold(ctx, in)
	if err != nil {
		return nil, err
	}

	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Set legal hold %s on %s/%s", status, bucket, key),
		"bucket":      bucket,
		"key":         key,
		"status":      status,
	}, nil
