// Package aws_s3_delete_bucket_tagging removes all tags from an S3 bucket.
package aws_s3_delete_bucket_tagging
...
const (
	...
	Description  = "Remove all tags from an AWS S3 bucket."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted all tags from %s", bucket),
	}, nil
}
