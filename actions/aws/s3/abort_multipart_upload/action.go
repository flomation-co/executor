// Package aws_s3_abort_multipart_upload aborts an in-progress S3 multipart
// upload and discards its uploaded parts.
package aws_s3_abort_multipart_upload
...
const (
	...
	Description  = "Abort an in-progress S3 multipart upload and discard its parts."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Aborted multipart upload %s for %s/%s", uploadID, bucket, key),
	}, nil
}
