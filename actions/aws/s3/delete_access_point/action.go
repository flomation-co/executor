// Package aws_s3_delete_access_point deletes an AWS S3 access point.
package aws_s3_delete_access_point
...
const (
	...
	Name         = "AWS S3 Delete Access Point"
	Description  = "Delete an AWS S3 access point by name."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted access point %s", name),
		"name":        name,
	}, nil
}
