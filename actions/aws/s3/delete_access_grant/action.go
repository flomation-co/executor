// Package aws_s3_delete_access_grant deletes an S3 Access Grant.
package aws_s3_delete_access_grant
...
const (
	...
	Name         = "AWS S3 Delete Access Grant"
	Description  = "Delete an S3 Access Grant by its ID, revoking the granted access."
...
var Inputs = [...]core.Connection{
	...
	{Name: "access_grant_id", Type: core.ConnectionTypeString, Label: "Access Grant ID", Placeholder: "The ID of the grant to delete", Required: true},
}
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.DeleteAccessGrant(ctx, &s3control.DeleteAccessGrantInput{
	...
	return map[string]interface{}{
		"tool_result":     fmt.Sprintf("Deleted access grant %s", grantID),
