// Package aws_s3_put_access_point_configuration_for_object_lambda updates an Object Lambda Access Point configuration.
package aws_s3_put_access_point_configuration_for_object_lambda
...
const (
	...
	Name         = "AWS S3 Put Object Lambda Configuration"
	Description  = "Replace the configuration document of an S3 Object Lambda Access Point."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	_, err = client.PutAccessPointConfigurationForObjectLambda(ctx, &s3control.PutAccessPointConfigurationForObjectLambdaInput{
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Updated configuration for Object Lambda Access Point %s", name),
	}, nil
}
