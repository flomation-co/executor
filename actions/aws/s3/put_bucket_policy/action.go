// Package aws_s3_put_bucket_policy attaches a policy document to an AWS S3 bucket.
package aws_s3_put_bucket_policy
...
const (
	...
	Description  = "Attach a JSON policy document to an AWS S3 bucket."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Applied policy to bucket %s", bucket),
		"bucket":      bucket,
	}, nil
}
