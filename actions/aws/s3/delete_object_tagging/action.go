// Package aws_s3_delete_object_tagging removes all tags from an S3 object.
package aws_s3_delete_object_tagging
...
const (
	...
	Description  = "Remove all tags from an object in AWS S3."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if _, err := client.DeleteObjectTagging(ctx, &awsS3.DeleteObjectTaggingInput{Bucket: aws.String(bucket), Key: aws.String(key)}); err != nil {
		return nil, err
	}

	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Deleted all tags from %s/%s", bucket, key),
	}, nil
}
