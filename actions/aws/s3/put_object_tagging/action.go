// Package aws_s3_put_object_tagging sets the tag set on an S3 object.
package aws_s3_put_object_tagging
...
const (
	...
	Description  = "Set (replace) the tag set on an object in AWS S3."
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Applied %d tag(s) to %s/%s", len(tags), bucket, key),
		"tag_count":   len(tags),
	}, nil
}
