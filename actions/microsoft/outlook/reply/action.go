// Package reply sends a reply to a Microsoft Outlook email message.
package reply
...
var Inputs = [...]core.Connection{
	...
	{Name: "comment", Type: core.ConnectionTypeString, Label: "Reply Message", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	if comment == "" {
		return microsoft.ErrorResult("comment is required")
	}
	...
	endpoint := fmt.Sprintf("%s/me/messages/%s/reply", microsoft.GraphAPI, messageID)
	...
	return map[string]interface{}{
		"tool_result": "Reply sent successfully",
		"success":     true,
		"error":       "",
	}, nil
}
