// Package create_draft creates a draft email in Microsoft Outlook.
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	endpoint := fmt.Sprintf("%s/me/messages", microsoft.GraphAPI)
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Draft created successfully with subject \"%s\"", subject),
		"draft_id":    draft.ID,
		"success":     true,
		"error":       "",
	}, nil
