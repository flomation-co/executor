// Package create creates a new empty Word document in Microsoft OneDrive.
package create
...
const (
	...
	wordContentType = "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
)
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	req.Header.Set("Content-Type", wordContentType)
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Created Word document %s", result.Name),
		"item_id":     result.ID,
