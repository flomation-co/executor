// Package send_channel_message posts a message to a Microsoft Teams channel.
package send_channel_message
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	endpoint := fmt.Sprintf("%s/teams/%s/channels/%s/messages", microsoft.GraphAPI, teamID, channelID)
	...
	return map[string]interface{}{
		"tool_result": fmt.Sprintf("Message sent successfully to channel %s", channelID),
