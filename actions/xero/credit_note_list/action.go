...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items := xero_common.Elements(resp, "CreditNotes")
	return xero_common.ListResult(items, fmt.Sprintf("Found %d Xero credit notes", len(items))), nil
}
