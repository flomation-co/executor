...
const (
	...
	Description  = "List Xero bank transfers, optionally filtered with a where clause."
	Summary      = "List bank transfers in Xero"
...
var Inputs = [...]core.Connection{
	...
	{Name: "where", Type: core.ConnectionTypeString, Label: "Where Filter", Placeholder: `Amount>=100`},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items := xero_common.Elements(resp, "BankTransfers")
	return xero_common.ListResult(items, fmt.Sprintf("Found %d Xero bank transfers", len(items))), nil
}
