...
var Inputs = [...]core.Connection{
	...
	{Name: "where", Type: core.ConnectionTypeString, Label: "Where Filter", Placeholder: `Status=="POSTED"`},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items := xero_common.Elements(resp, "ManualJournals")
	return xero_common.ListResult(items, fmt.Sprintf("Found %d Xero manual journal(s)", len(items))), nil
}
