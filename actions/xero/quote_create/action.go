...
var Inputs = [...]core.Connection{
	...
	{Name: "contact_id", Type: core.ConnectionTypeString, Label: "Customer Contact ID", Placeholder: "00000000-0000-0000-0000-000000000000", Required: true},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	id, _ := obj["QuoteID"].(string)
	return xero_common.ObjectResult(id, obj, "Created Xero quote"), nil
}
