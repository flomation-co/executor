...
var Inputs = [...]core.Connection{
	...
	{Name: "where", Type: core.ConnectionTypeString, Label: "Where Filter", Placeholder: `Type=="SPEND"`},
...
func Execute(flow *core.Flow, node *core.Node, inputs []*core.Connection) (map[string]interface{}, error) {
	...
	items := xero_common.Elements(resp, "BankTransactions")
	return xero_common.ListResult(items, fmt.Sprintf("Found %d Xero bank transactions", len(items))), nil
}
